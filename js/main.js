...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    let activeIndex = 0; // Track active button index
    let cycleInterval;
  
    // Create green line dynamically
    ...
    function setActiveTab(index) {
      ...
      // Add active class to the selected button and corresponding content
      buttons[index].classList.add('active');
      document.getElementById(buttons[index].dataset.tab).classList.add('active');
      
      // Adjust the green line
      const buttonWidth = buttons[index].offsetWidth;
      const buttonLeft = buttons[index].offsetLeft;
      greenLine.style.width = `${buttonWidth}px`;
      greenLine.style.left = `${buttonLeft}px`;
    }
    ...
    buttons.forEach((button, index) => {
      button.addEventListener('click', () => {
        ...
        setActiveTab(activeIndex);
        startCycling(); // Restart the cycling
      });
    });
  
    // Initialize the cycling and set the first tab as active
    setActiveTab(activeIndex);
    startCycling();
